...
global.ownername = process.env.OWNER_NAME === undefined ? "👿චුට්ටා👿" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '9476 018 7237' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
